...
class UserPendingRebateFilterComponent extends Component {
    ...
    goToWalletRecordFilterResult() {
        ...
        this.props.navigation.navigate('UserMe_Sub_PendingRebate_Filter_Result', {
            StartDateText,
            EndDateText,
        });
    }
    ...
    render() {
        ...
        return (
            <Container style={merchantMainContainer}>
                <GoBackHeader
                    headerTitle={strings('pending_rebate.pending_rebate')}
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {strings('pending_rebate.pending_rebate')}
                            </Text>
...
})(UserPendingRebateFilterComponent);
