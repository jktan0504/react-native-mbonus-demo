...
class UserWalletFilterComponent extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            EndDateText: '',
            EndDateHolder: null,
            WALLET_TITLE: this.props.navigation.getParam('WALLET_TITLE', ''),
            WALLET_SUBTITLE: this.props.navigation.getParam('WALLET_SUBTITLE', ''),
    ...
    goToWalletRecordFilterResult() {
        const { StartDateText, EndDateText, WALLET_ACTION_ID } = this.state;

        this.props.navigation.navigate('UserMe_Sub_Wallet_Filter_Result', {
            StartDateText,
            EndDateText,
            WALLET_ACTION_ID
        });
    ...
    render() {
        ...
        return (
            <Container style={merchantMainContainer}>
                <GoBackHeader
                    headerTitle={this.state.WALLET_TITLE}
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {this.state.WALLET_TITLE}
                            </Text>
                            <Item rounded style={subTitleContainerItemStyle}>
                                <View style={{ flex: 0.4 }}>
                                    <ImageBackground
                                        source={require('../../../../../../assets/images/me/left_round_label.png')}
                                        style={{ flex: 1,
